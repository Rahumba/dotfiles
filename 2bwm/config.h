...
#define MOD1           XCB_MOD_MASK_1       /* Super/Windows key  or check xmodmap(1) with -pm  defined in /usr/include/xcb/xproto.h */
///--Speed---///
...
///--Menus and Programs---///
static const char *menucmd[]   = { "dmenu_run", "-p", "run:", NULL };
static const char *jgmenucmd[]   = { "jgmenu", "--simple", "--csv-file=~/.config/jgmenu/menu.csv", NULL };
...
static key keys[] = {
    ...
    {  MOD1 ,              XK_Tab,        focusnext,         {.i=TWOBWM_FOCUS_NEXT}},
    {  MOD1 |SHIFT,        XK_Tab,        focusnext,         {.i=TWOBWM_FOCUS_PREVIOUS}},
    // Kill a window
    {  MOD ,              XK_q,          deletewin,         {}},
    // Resize a window
    ...
    // Maximize and move
    // vertically left
    {  MOD |SHIFT,        XK_t,          maxhalf,           {.i=TWOBWM_MAXHALF_VERTICAL_LEFT}},
    // vertically right
    ...
    // Start programs
    {  MOD1 ,              XK_p,          start,             {.com = menucmd}},
    {  MOD ,               XK_Return,     start,             {.com = terminal}},
    {  MOD1 |SHIFT,        XK_l,          start,             {.com = slock}},
    // Exit or restart 2bwm
    {  MOD1 |CONTROL,      XK_q,          twobwm_exit,       {.i=0}},
    {  MOD1 |CONTROL,      XK_r,          twobwm_restart,    {.i=0}},
    {  MOD1 ,              XK_space,      halfandcentered,   {.i=0}},
    {  MOD1 ,              XK_s,          toggle_sloppy,     {.com = sloppy_switch_cmd}},
...
static Button buttons[] = {
    {  MOD1        ,XCB_BUTTON_INDEX_1,     mousemotion,   {.i=TWOBWM_MOVE}, false},
    {  MOD1        ,XCB_BUTTON_INDEX_3,     mousemotion,   {.i=TWOBWM_RESIZE}, false},
    {  0          ,XCB_BUTTON_INDEX_3,     start,         {.com = jgmenucmd}, true},
    {  MOD1|SHIFT,  XCB_BUTTON_INDEX_1,     changeworkspace, {.i=0}, false},
    {  MOD1|SHIFT,  XCB_BUTTON_INDEX_3,     changeworkspace, {.i=1}, false},
    {  MOD1|ALT,    XCB_BUTTON_INDEX_1,     changescreen,    {.i=1}, false},
    {  MOD1|ALT,    XCB_BUTTON_INDEX_3,     changescreen,    {.i=0}, false}
};
